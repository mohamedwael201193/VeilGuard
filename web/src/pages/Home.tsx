      ...
      <main className="flex-1">
        ...
        <section className="relative py-24 md:py-32 overflow-hidden">
          ...
          <div className="absolute inset-0 -z-10">
            <AnimatedBlob color="violet" size={500} delay={0} className="top-20 -left-20" />
            <AnimatedBlob color="cyan" size={400} delay={1} className="bottom-20 -right-20" />
            <AnimatedBlob color="lime" size={350} delay={2} className="top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2" />
          </div>
            ...
            <div className="max-w-4xl mx-auto text-center space-y-8">
              ...
              >
                ...
                <p className="text-xl md:text-2xl text-muted-foreground max-w-2xl mx-auto">
                  One-time stealth address per invoice. zk-receipts coming in Wave 4.
                </p>
              </motion.div>
              ...
              >
                <Link to="/invoice/new">
                  <Button size="lg" className="magnetic bg-primary hover:bg-primary/90 text-primary-foreground glow-lime group">
                    Create Invoice
            ...
            <div className="grid md:grid-cols-3 gap-8 max-w-5xl mx-auto">
              ...
              >
                ...
                <p className="text-muted-foreground">
                  Each invoice gets a unique one-time address. No payment history linkage.
                </p>
              </motion.div>
              ...
              >
                ...
                <p className="text-muted-foreground">
                  No personal data on-chain. Minimal metadata. Privacy by design.
                </p>
              </motion.div>
              ...
              >
                ...
                <p className="text-muted-foreground">
                  Polygon PoS speed. USDC stablecoin. Real-time payment tracking.
                </p>
              </motion.div>
            </div>
          </div>
            ...
            <div className="max-w-3xl mx-auto space-y-12">
              ...
              >
                ...
                <p className="text-muted-foreground text-lg">
                  Private invoicing in three simple steps
                </p>
              </motion.div>
                ...
                {[
                  {
                    ...
                    description: 'Set amount, token, and optional memo. We generate a unique stealth address.',
                  },
                  {
                    step: '02',
                    title: 'Share Payment Link',
                    description: 'Send the invoice link or QR code. No personal info exposed.',
                  },
                  {
                    step: '03',
                    title: 'Get Paid Privately',
                    description: 'Receive payment to stealth address. Track status in dashboard.',
                  },
                ].map((item, i) => (
                  <motion.div
                    key={i}
